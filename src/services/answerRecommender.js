 ...
 */
export function generateContentIdeas(contest, tone, personalNote) {
  const frame = toneFrames[tone] ?? toneFrames.Warm;
...
export function generateIdeasFor(contest, tone, personalNote) {
  switch (detectFormat(contest)) {
    case FORMATS.MEDIA:
      return generateContentIdeas(contest, tone, personalNote);
    case FORMATS.ACTION:
    ...
    default:
      return generateAnswerIdeas(contest, tone, personalNote);
  }
}
